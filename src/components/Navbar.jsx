...
import { Globe, ChevronDown, Check, Menu, X, LogOut, User, Bell, Sun, Moon } from "lucide-react";
      ...
      >
        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200">
          ...
          <div className="flex items-center gap-2">
            ...
            {user && <button className="p-2 text-gray-600"><Bell size={20} /></button>}
            <button onClick={() => setIsMobileOpen(false)} className="p-2"><X className="w-5 h-5" /></button>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 px-4 pt-4 mt-2">
          ...
          {user && (
            <div className="mb-4 px-4 py-3 rounded-xl bg-gray-50 flex items-center gap-3">
              ...
              <span className="font-bold text-gray-700">{getUserFullName(user) || "User"}</span>
            </div>
          )}
