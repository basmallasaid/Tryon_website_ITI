  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-3xl max-h-[90vh] md:max-h-none rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in duration-300 border border-gray-100 md:overflow-hidden overflow-y-auto">
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 rtl:left-3 z-20 p-1.5 bg-white/90 backdrop-blur-sm rounded-full text-gray-500 shadow-md md:hidden"
        >
          <X size={18} />
        </button>
        ...
        <div className="md:w-[60%] p-5 md:p-8 flex flex-col justify-between bg-white">
          ...
          <div className="flex items-center gap-3 md:gap-4 mt-6 md:mt-10">
            ...
            <button
              ...
              className="flex-1 bg-[var(--color-primary)] text-white py-3 md:py-4 rounded-xl md:rounded-2xl font-bold shadow-lg shadow-gray-200 hover:shadow-gray-300 transition-all flex items-center justify-center gap-2 md:gap-3 rtl:flex-row-reverse active:scale-[0.98]"
            >
