...
export default function SlidingOverlay({ view, onToggle, inModal }) {
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col items-center text-center ${inModal ? "p-6" : "p-12"} backdrop-blur-[2px]`}
      >
        {isOtp ? (
          <>
            <div
              className={`bg-white/20 p-4 rounded-full mb-6 backdrop-blur-md`}
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
            ...
            <h1
              className={`font-bold ${inModal ? "mb-3 text-4xl" : "mb-4 text-5xl"}`}
            >
          ...
          <>
            ...
            <button
              onClick={onToggle}
              className="group relative overflow-hidden rounded-2xl border-2 border-white/70 px-12 py-3 text-xl font-bold transition-all hover:border-white cursor-pointer"
            >
          ...
          <>
            <h1 className="font-extrabold leading-tight mb-4">
              <span className="block text-4xl font-light italic opacity-90">
                {t("auth.welcome")}
              </span>
              <span className="block text-6xl tracking-tight">
                {t("auth.backOverlay")}
              </span>
            </h1>
            ...
            <button
              onClick={onToggle}
              className="group relative overflow-hidden rounded-2xl border-2 border-white/70 px-16 py-3 text-xl font-bold transition-all hover:border-white shadow-xl cursor-pointer"
            >
              <span className="relative z-10 group-hover:text-primary transition-colors">
                {t("auth.signUp")}
              </span>
          ...
          <>
            <h1 className="font-light text-4xl italic mb-1">
              {t("auth.welcomeTo")}
            </h1>
            <h2 className="font-black text-5xl mb-6 tracking-tighter uppercase">
              {t("footer.brand")}
            </h2>
            <p className="opacity-80 text-lg mb-12 max-w-xs">
