                  ...
                  <div className="relative w-44 sm:w-52 rounded-2xl p-3 sm:p-4 bg-info-bg">
                    <div className="relative aspect-[3/4] overflow-hidden rounded-lg bg-surface-elevated">
                      ...
                      <button
                        ...
                        className={`absolute ${isArabic ? 'left-2' : 'right-2'} top-2 flex h-7 w-7 items-center justify-center rounded-full bg-surface-elevated/90 text-text-secondary shadow-md transition-all duration-200 hover:bg-error-text hover:text-white hover:scale-110`}
                      >
                        <X className="h-4 w-4" />
                      </button>
                    </div>
