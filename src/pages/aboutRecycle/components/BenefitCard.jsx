export default function BenefitCard({ icon: Icon, title, description, bgColor, iconColor }) {
  return (
    <div className="group relative bg-surface-elevated rounded-2xl p-8 border border-[var(--border)] hover:border-transparent transition-all duration-300 hover:shadow-xl">
