  ...
  return (
    <>
      ...
      <div className={`lg:hidden fixed inset-0 z-40 transition-opacity duration-300 ${showMore ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`} onClick={() => setShowMore(false)}>
        ...
        <div
          className={`absolute top-0 right-0 bottom-0 w-[280px] bg-admin-surface shadow-xl flex flex-col transition-transform duration-300 ease-out ${showMore ? 'translate-x-0' : 'translate-x-full'}`}
