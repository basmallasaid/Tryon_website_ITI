export default function TopCategoriesChart() {
  const categories = [
    { color: 'bg-admin-brand', label: 'Luxury Footwear' },
    { color: 'bg-admin-success', label: 'Accessories' },
    { color: 'bg-admin-category', label: 'Ready-to-wear' },
  ];
  ...
  return (
    <div className="flex-1 bg-white border-2 border-[#D5D9DE] rounded-panel p-6 flex flex-col gap-6">
      ...
      <div className="flex items-center gap-8">
        ...
        >
          <span className="text-xs font-bold text-admin-text-primary">78%</span>
        </div>
