  ...
  return (
    <div className="p-8">
      ...
      {loadingThread ? (
        ...
        <>
          {/* Root Message */}
          <div className="bg-admin-surface border border-admin-border/40 rounded-xl shadow-sm mb-6">
          ...
          {replies.length > 0 && (
            <div className="mb-6 space-y-4">
              ...
              {replies.map((reply) => {
                ...
                return (
                  <div key={reply._id} className={`bg-admin-surface border rounded-xl shadow-sm ${isFromAdmin ? 'border-admin-brand/30 ml-4' : 'border-admin-border/40'}`}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-admin-surface border border-admin-border/40 rounded-xl text-sm text-admin-text-primary outline-none resize-none focus:border-admin-brand transition-colors placeholder:text-admin-text-muted"
                />
              </div>
            </div>
