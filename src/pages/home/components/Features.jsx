...
const Features = () => {
  return (
    <section className="w-full bg-[#F4F3F5] pr-20 pb-20 pl-20 max-[1200px]:pr-14 max-[1200px]:pl-14 max-[1000px]:pr-8 max-[1000px]:pl-8 max-[1000px]:pb-8 flex flex-col items-center gap-10">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="font-semibold text-base text-center text-[var(--text-secondary)]">
      ...
      <div className="flex items-center justify-center gap-8 max-[1200px]:flex-col">
        {cards.map((card) => (
          <div
            key={card.title}
            className="w-[356px] h-[356px] max-[1000px]:w-full rounded-2xl pt-10 pb-10 px-6 flex flex-col gap-4 shadow-[0_0_4px_0_#00000026] bg-[var(--surface-elevated)]"
          >
            <div
            ...
            <h3 className="pt-4 font-bold text-2xl leading-[34px] text-[var(--Secondary-Text-color)]">
              {card.title}
            </h3>
            <p className="opacity-80 font-normal text-base leading-[23px] text-[var(--text-secondary)]">
              {card.desc}
            </p>
          </div>
        ))}
