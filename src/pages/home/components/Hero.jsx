    ...
    <section className="w-full bg-[#F4F3F5] px-20 py-20 max-[1200px]:px-14 max-[1000px]:p-8 flex items-center justify-center gap-[26px] max-[1000px]:flex-col">
      <div className="w-[414px] max-[1000px]:w-full flex flex-col gap-6">
        <h1 className="font-bold text-[64px] max-[1000px]:text-4xl max-[600px]:text-3xl leading-[69px] max-[1000px]:leading-tight">
          <span className="text-[var(--Primary-Text-color)]">Your Personal</span>{" "}
          <span className="bg-gradient-to-r from-[#4FC3FF] via-[#74D6B6] to-[#ACF445] bg-clip-text text-transparent">
            AI Stylist.
          </span>
        </h1>
        <p className="font-semibold text-base max-[600px]:text-sm leading-[22px] text-[var(--Disabled-Text-color)] w-[327px] max-[1000px]:w-full">
