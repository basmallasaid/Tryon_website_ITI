      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 text-text-disabled hover:text-text-primary transition-colors p-1"
  ...
  if (mobile) {
    return (
      <div className="w-full px-5 py-8 sm:px-8">
        ...
        <p className="mt-2 text-text-secondary leading-relaxed mb-6 text-sm">
