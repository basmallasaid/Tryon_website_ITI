...
export default function ForgotPassword({ isVisible, onForgot, onBackToLogin, inModal, mobile }) {
        ...
        <form onSubmit={onForgot} className="space-y-5">
          ...
          <div className="pt-2 text-center">
            <button
              ...
              className="group inline-flex items-center gap-2 font-bold text-[var(--primary)] text-sm hover:opacity-80 transition-opacity"
            >
              <ArrowLeft size={16} className="transition-transform rtl:rotate-180 group-hover:ltr:-translate-x-1 group-hover:rtl:translate-x-1" />
