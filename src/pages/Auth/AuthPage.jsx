...
export default function AuthPage({
  ...
  const handleGoogleLogin = () => {
    ...
    window.googleAuthPopup = window.open(
      `${import.meta.env.VITE_API_URL}/auth/google?lang=${i18n.language}`,
      "google-auth",
  ...
  return (
    <div
      ...
      className={`font-sans ${inModal ? "" : "min-h-screen flex items-center justify-center bg-surface-elevated p-4"}`}
    >
      ...
      <div className={`hidden md:block w-full ${inModal ? "" : "max-w-6xl"}`}>
        <div
          className={`relative ${inModal ? "h-[600px]" : "h-[750px]"} w-full overflow-hidden rounded-[40px] bg-surface-elevated shadow-2xl`}
        >
          <Login
